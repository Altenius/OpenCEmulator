...
{
public:
    InstanceConfig(const std::string &uuid, const std::string &label, std::vector<std::string> &&components) : m_uuid(
            uuid), m_label(label), m_components(std::move(components))
    {
