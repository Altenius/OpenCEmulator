...
float FourBitPalette::delta(int colorA, int colorB) { // https://github.com/MightyPirates/OpenComputers/blob/master-MC1.7.10/src/main/scala/li/cil/oc/util/PackedColor.scala#L84
    ...
    return 0.2126 * rD * rD * 0.7152 * gD * gD * 0.0722 * bD * bD; // This calculates the distance between colorA and colorB.
}
