...
struct MethodInfo
{
    ...
    MethodInfo(std::string doc_, bool direct_, bool getter_, bool setter_) : doc(doc_), direct(direct_),
                                                                             getter(getter_), setter(setter_)
    {};
};
...
{
public:
    Component(const std::string &type, const std::string &uuid = std::string(),
              const std::string &label = std::string());

    static ComponentPtr
    create(const std::string &type, const std::string &uuid = std::string(), const std::string &label = std::string(),
...
protected:
    inline void
    registerMethod(std::string name, ComponentMethod method, std::string doc, bool direct = false, bool getter = false,
                   bool setter = false)
    {
